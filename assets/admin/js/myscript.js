                    ...
                    <div class="row">
                      ...
                      <div class="col-10">
                        <div class="price-container">
                          ...
                          <input type="number" class="input-field price-input" id="${data[i].attribute.input_name}${data[i].options[j].id}_price" data-name="${data[i].attribute.input_name}_price[]" placeholder="0 (Additional Price)" value="" >
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-7 ${priceClass}">
                      <div class="row">
                        ...
                        <div class="col-10">
                          <div class="price-container">
                            <span class="price-curr">${curr.sign}</span>
                            <input type="number" id="${data[i].attribute.input_name}${data[i].options[j].id}_price" class="input-field price-input" data-name="${data[i].attribute.input_name}_price[]" placeholder="0 (Additional Price)" value="" >
                          </div>
                        </div>
                      </div>
                    </div>
...
if(admin_loader == 1)
  ...
  $('#modal1').find('.modal-title').html('اضافه کردن');
...
if(admin_loader == 1)
  ...
  $('#modal1').find('.modal-title').html('ویرایش');
  $('#modal1 .modal-content .modal-body').html('').load($(this).attr('data-href'),function(response, status, xhr){
      if(status == "success")
      {
        if(admin_loader == 1)
...
if(admin_loader == 1)
  ...
  $('#modal2').find('.modal-title').html($('#headerdata').val()+' برجسته');
...
if(admin_loader == 1)
  ...
  $('#modal1').find('.modal-title').html('جزئیات ' + $('#headerdata').val());
  $('#modal1 .modal-content .modal-body').html('').load($(this).attr('data-href'),function(response, status, xhr){
      if(status == "success")
      {
        if(admin_loader == 1)
...
if(admin_loader == 1)
  ...
  $('#modal1').find('.modal-title').html('پیگیری سفارش');
  $('#modal1 .modal-content .modal-body').html('').load($(this).attr('data-href'),function(response, status, xhr){
      if(status == "success")
      {
        if(admin_loader == 1)
...
if(admin_loader == 1)
  ...
  $('#modal1').find('.modal-title').html('وضعیت تحویل');
  $('#modal1 .modal-content .modal-body').html('').load($(this).attr('data-href'),function(response, status, xhr){
      if(status == "success")
      {
        if(admin_loader == 1)
