...
//Route::view('/front/products', 'front/products');
//Route::view('/user-panel', 'front/user');
//Route::view('/register', 'user/register');
Route::view('/front/edit-profile', 'front/edit-profile');
Route::view('/front/edit-password', 'front/edit -password');
Route::view('/front/common-question', 'front/common-question');
Route::view('/front/discount-coupon', 'front/discount-coupon');
Route::view('/front/shopping-guide', 'front/shopping-guide');



Route::post('getSuggestAddress','User\AddressController@getSuggestAddress')->name('get.suggest.address');
Route::post('getAddressWithCoordinate','User\AddressController@getAddressWithCoordinate')->name('get.address.with.coordinate');
...
// Verification Section Ends
 ...
 //------------ ADMIN PRODUCT DISCUSSION SECTION ENDS ------------
  ...
  Route::get('/general-settings/products', 'Admin\GeneralSettingController@products')->name('admin-gs-products');
...
// ------------ GLOBAL ----------------------
  ...
  Route::post('/general-settings/update/all', 'Admin\GeneralSettingController@productQty')->name('admin-gs-product-qty-update');
...
Route::prefix('user')->group(function() {
  ...
  // User Dashboard
  Route::get('/dashboard', 'User\OrderController@orders')->name('user-dashboard');
  ...
  Route::post('/register/verify/code', 'User\RegisterController@checkVerifyCode')->name('check.verify.code');
  ...
  // User Reset End
    ...
    // User Address
    Route::get('/load/address', 'User\AddressController@loadAddress')->name('load-address');
    Route::get('/address', 'User\UserController@address')->name('user-address');
    Route::post('/address', 'User\UserController@addressSubmit')->name('user-address-submit');
    // User Address End
  ...
  Route::post('/send-verify-code', 'User\ForgotController@sendVerifyCode')->name('send-verify-code');
  Route::post('/reset/password', 'User\ForgotController@resetPassword')->name('reset-password');
  // User Forgot Ends
...
/*ُ Static Page */
Route::view('/send-order', 'front/send-order')->name('send-order');
Route::view('/contact-us', 'front/contact-us')->name('contact-us');
Route::view('/terms-of-use', 'front/using-conditions')->name('terms-of-use');
Route::view('/privacy', 'front/privacy')->name('privacy');
Route::view('/payment-method', 'front/payment-method')->name('payment-method');
Route::view('/procedures-for-returning', 'front/returning')->name('procedures-for-returning');
Route::view('/common-question', 'front/common-question')->name('common-question');
...
//  Route::get('/category/{slug1}/{slug2}/{slug3}','Front\CatalogController@childcategory')->name('front.childcat');
  ...
  Route::get('/checkout/products/','Front\CheckoutController@load_checkout_products');
  ...
  Route::post('/product/buy', 'Front\CheckoutController@buyProduct')->name('product.buy');
  Route::get('/order/tracking', 'Front\CheckoutController@orderTracking')->name('order.tracking');
