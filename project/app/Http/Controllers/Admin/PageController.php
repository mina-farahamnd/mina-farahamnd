    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ->addColumn('header', function(Page $data) {
                                ...
                                return '<div class="action-list"><select class="process select droplinks '.$class.'"><option data-val="1" value="'. route('admin-page-header',['id1' => $data->id, 'id2' => 1]).'" '.$s.'>'.__('Showed').'</option><option data-val="0" value="'. route('admin-page-header',['id1' => $data->id, 'id2' => 0]).'" '.$ns.'>'.__('Not Showed').'</option></select></div>';
                            }) 
                            ->addColumn('footer', function(Page $data) {
                                ...
                                return '<div class="action-list"><select class="process select droplinks '.$class.'"><option data-val="1" value="'. route('admin-page-footer',['id1' => $data->id, 'id2' => 1]).'" '.$s.'>'.__('Not Showed').'</option><<option data-val="0" value="'. route('admin-page-footer',['id1' => $data->id, 'id2' => 0]).'" '.$ns.'>'.__('Not Showed').'</option>/select></div>';
                            }) 
