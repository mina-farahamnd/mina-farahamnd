    ...
    <li>
        <a href="#banner" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false">
            <i class="fas fa-upload"></i>{{ __('بنرهای وبسایت') }}
        </a>
        <ul class="collapse list-unstyled" id="banner" data-parent="#accordion">

            <li>
                <a href="{{ route('admin-sb-index') }}">بارگذاری بنر تبلیغاتی</a>
            </li>

            <li>
                <a href="{{ route('admin-sb-bottom') }}">بارگذاری بنر پیشنهاد ویژه</a>
            </li>

            <li>
                <a href="{{ route('admin-sb-large') }}">بارگذاری بنر جستجوی آکام پارس</a>
            </li>
        </ul>
    </li>

    <li>
        <a href="{{ route('admin-brand-index') }}"><i class="fas fa-upload"></i>بارگذاری برندها</a>
    </li>



    <li>
        <a href="{{ route('admin-gs-products') }}"><i class="fas fa-upload"></i>تنظیمات محتوا</a>
    </li>