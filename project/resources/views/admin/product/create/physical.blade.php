...
@section('content')
	...
	<div class="panel panel-body">
		<div class="span4 cropme text-center" id="landscape" style="width: 400px; min-height: 100px; border: 1px dashed black;">
		</div>
		</div>
	</div>
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
							                      ...
							                      <input type="hidden" id="org_photo" name="org_photo" value="">
						                    ...
						                    <div class="showbox">
												...
												<div class="row" id="stckprod">
													...
													<div class="col-lg-7">
														<input name="stock" type="number" class="input-field" placeholder="{{ __('e.g 20') }}">
														<div class="checkbox-wrapper">
														...
														<div class="featured-keyword-area">
															...
															<div class="feature-tag-top-filds" id="specification-section">
																<div class="feature-area">
																	...
																	<div class="row">
																		<div class="col-lg-6">
																		<input type="text" name="specification_keys[]" class="input-field" placeholder="ویژگی">
																		</div>

																		<div class="col-lg-6">
											                                <div class="input-group">
											                                  <input type="text" name="specification_values[]"  class="input-field " placeholder="توضیح"/>
											                                </div>
																		</div>
																	</div>
																</div>
