					...
					<div class="product-description">
						...
						<form id="geniusformdata" action="{{route('admin-prod-feature',$data->id)}}" method="POST" enctype="multipart/form-data">
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="left-area">
											<h4 class="heading">{{ __("Highlight in") }} {{-- {{ $langg->lang26 }} --}} پیشنهاد هاهوت *</h4>
									</div>
								</div>
									<div class="col-sm-3">
									<label class="switch">
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="left-area">
											<h4 class="heading">{{ __("Highlight in") }}  {{--{{ $langg->lang27 }}--}} اسلایدر * </h4>
									</div>
								</div>
									<div class="col-sm-3">
									<label class="switch">
							...
							<div class="row">
								<div class="col-lg-8">
									<div class="left-area">
											<h4 class="heading">{{ __("Highlight in") }}  {{-- {{ $langg->lang30 }} --}} محصولات ویژه *</h4>
									</div>
								</div>
									<div class="col-sm-3">
									<label class="switch">
							...
							{{--<div class="row">
								<div class="col-lg-8">
									<div class="left-area">
											<h4 class="heading">{{ __("Highlight in") }} تخفیف خورده *</h4>
									</div>
								</div>
									<div class="col-sm-3">
									<label class="switch">
