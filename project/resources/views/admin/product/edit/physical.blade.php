												...
												<div id="catAttributes">
													...
													@foreach ($catAttributes as $catAttribute)
															<div class="row">
																 <div class="col-lg-4">
																		<div class="left-area">
																			 <h4 class="heading">{{ __($catAttribute->name) }} *</h4>
																		</div>
																 </div>
																 <div class="col-lg-7">
																	 <?php
																					...
																					<div class="row">
																						 ...
																						 <div class="col-10">
																								<div class="price-container">
																									 ...
																									 <input type="number" class="input-field price-input" id="{{ $catAttribute->input_name }}{{$option->id}}_price" data-name="{{ $catAttribute->input_name }}_price[]" placeholder="0.00 {{__('Additional Price')}}" value="{{ !empty($selectedAttrs["$inName"]['prices'][$i]) && $checked == 1 ? $selectedAttrs["$inName"]['prices'][$i] : '' }}">
																								</div>
																						 </div>
																					</div>
																			 </div>
													...
													@if (!empty($subAttributes))
														@foreach ($subAttributes as $subAttribute)
															<div class="row">
																 <div class="col-lg-4">
																		<div class="left-area">
																			 <h4 class="heading">{{ __($subAttribute->name) }} *</h4>
																		</div>
																 </div>
																 <div class="col-lg-7">
																		 <?php
																			    ...
																			    <div class="col-lg-7 {{ $subAttribute->price_status == 0 ? 'd-none' : '' }}">
																			       <div class="row">
																			          ...
																			          <div class="col-10">
																			             <div class="price-container">
																			                <span class="price-curr">{{ $sign->sign }}</span>
																			                <input type="number" class="input-field price-input" id="{{ $subAttribute->input_name }}{{$option->id}}_price" data-name="{{ $subAttribute->input_name }}_price[]" placeholder="0.00 (Additional Price)" value="{{ !empty($selectedAttrs["$inName"]['prices'][$i]) && $checked == 1 ? $selectedAttrs["$inName"]['prices'][$i] : '' }}">
																			             </div>
																			          </div>
																			       </div>
																			    </div>
																				...
																				<div class="col-lg-7 {{ $childAttribute->price_status == 0 ? 'd-none' : '' }}">
																					 <div class="row">
																							...
																							<div class="col-10">
																								 <div class="price-container">
																										<span class="price-curr">{{ $sign->sign }}</span>
																										<input type="number" class="input-field price-input" id="{{ $childAttribute->input_name }}{{$option->id}}_price" data-name="{{ $childAttribute->input_name }}_price[]" placeholder="0.00 {{__('Additional Price')}}" value="{{ !empty($selectedAttrs["$inName"]['prices'][$i]) && $checked == 1 ? $selectedAttrs["$inName"]['prices'][$i] : '' }}">
																								 </div>
																							</div>
																					 </div>
																				</div>
		...
		<div class="span4 cropme text-center" id="landscape" style="width: 400px; height: 400px; border: 1px dashed black;">
			...
			<a href="javascript:;" id="crop-image" class="d-inline-block mybtn1">
				<i class="icofont-upload-alt"></i> {{ __('Upload Image Here') }}
							                      ...
							                      <input type="hidden" id="org_photo" name="org_photo" value="{{ $data->org_photo }}" accept="image/*">
																	...
																	<div class="select-input-color" id="color-section">
																		@foreach($data->color as $color)
																			<div class="row color-area">
																				...
																				<div class="col-lg-4">
																					<input type="text" name="color_name[]" class="input-field" placeholder="نام رنگ" value="{{$color->color_name}}">
																				</div>
																				<div class="col-lg-4">
																					<div class="input-group colorpicker-component cp">
																						<input type="text" name="color_values[]" value="{{$color->color_values}}"  class="input-field cp"/>
																						<span class="input-group-addon"><i></i></span>
																					</div>
																				</div>
																				<div class="col-lg-4">
																					<input type="number" name="color_inventory[]" class="input-field" placeholder="موجودی رنگ" value="{{$color->color_inventory}}">
																				</div>
																			</div>
											                         	@endforeach
											                         </div>
															...
															<div  class="col-lg-7">
																<div class="select-input-color" id="color-section">
																	<div class="color-area">
																		...
																		<div class="row">
																			<div class="col-lg-4">
																				<input type="text" name="color_name[]" class="input-field" placeholder="نام رنگ">
																			</div>
																			<div class="col-lg-4">
																				<div class="input-group colorpicker-component cp">
																					<input type="text" name="color_values[]" value="#000000"  class="input-field cp"/>
																					<span class="input-group-addon"><i></i></span>
																				</div>
																			</div>
																			<div class="col-lg-4">
																				<input type="number" name="color_inventory[]" class="input-field" placeholder="موجودی رنگ">
																			</div>
																		</div>
																	 </div>
																</div>
						                    ...
						                    <div class="{{ !empty($data->whole_sell_qty) ? "":"showbox" }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input name="stock" type="number" class="input-field" placeholder="e.g 20" value="{{ $data->stock }}">
														<div class="checkbox-wrapper">
											...
											<div class="{{ $data->measure == null ? 'showbox' : '' }}">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<div class="featured-keyword-area">
															<div class="heading-area">
																<h4 class="title">ﻣشخصات ﮐﺎﻻ </h4>
															</div>

															<div class="feature-tag-top-filds" id="specification-section">
																@if (!empty($data->specifications))
																	@foreach (json_decode($data->specifications) as $key => $value)
																	<div class="feature-area">
																		<span class="remove specification-remove"><i class="fas fa-times"></i></span>
																		<div class="row">
																			<div class="col-lg-6">
																			<input type="text" name="specification_keys[]" class="input-field" placeholder="ویژگی" value="{{$key}}">
																			</div>

																			<div class="col-lg-6">
																				<div class="input-group">
																				<input type="text" name="specification_values[]"  class="input-field " placeholder="توضیح" value="{{$value}}">
																				</div>
																			</div>
																		</div>
																	</div>
															...
															<a href="javascript:;" id="specification-btn" class="add-fild-btn"><i class="icofont-plus"></i> {{ __('Add More Field') }}</a>
														</div>
													</div>
												</div>
...
$('.cropme').click();
 ...
 setTimeout(
    function() {
  	...
  	var org_photo = $('#org_photo').val();

      $.ajax({
        url: "{{route('admin-prod-upload-update',$data->id)}}",
        type: "POST",
        data: {"image":img , "org_photo" : org_photo},
        success: function (data) {
          if (data.status) {
            $('#feature_photo').val(data.photo);
            $('#org_photo').val(data.org_photo);
          }
          if ((data.errors)) {
