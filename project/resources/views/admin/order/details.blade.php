                                            ...
                                            <table class="table">
                                                ...
                                                @if($order->shipping_title != null)
                                                    <tr>
                                                        ...
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{ __($order->shipping_title) }}</td>
                                                    </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{ (int)($order->shipping_cost ) }}{{ $order->currency_sign }}</td>
                                                </tr>
                                                @endif
                                                ...
                                                @if($order->packing_title != null)
                                                    <tr>
                                                        ...
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{ __($order->packing_title) }}</td>
                                                    </tr>
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{ (int)$order->packing_cost  }}{{ $order->currency_sign }}</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{ (int)$order->wallet_price  * $order->currency_value  }}</td>
                                                </tr>
    
                                                    @if($order->method != "Wallet")
                                                    <tr>
                                                        <th width="45%">{{__($order->method)}}</th>
                                                        <td width="10%">:</td>
                                                        <td width="45%">{{$order->currency_sign}}{{ (int)$order->pay_amount  * $order->currency_value }}</td>
                                                    </tr>
                                                    @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{$order->currency_sign}}{{(int)($order->pay_amount + $order->wallet_price)  * $order->currency_value  }}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10%">:</td>
                                                    <td width="45%">{{__($order->method)}}</td>
                                                </tr>
                                            ...
                                            <table class="table">
                                                <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th width="10%">:</th>
                                                            @if($gs->currency_format == 0)
                                                            <td width="45%">{{ $order->currency_sign }}{{(int)($order->affilate_charge * $order->currency_value)}}</td>
                                                            @else 
                                                            <td width="45%">{{(int)($order->affilate_charge * $order->currency_value)}}{{ $order->currency_sign }}</td>
                                                            @endif
                                                        </tr>
                                                        @endif
                                                </tbody>
                              ...
                              <a href="javascript:;" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info product-btn" id="license" style="padding: 5px 12px;"><i class="fa fa-eye"></i> {{ __('View License') }}</a>
                                            ...
                                            <td>
                                               ...
                                               @if($product['color'])
                                                ...
                                                @endif
                                                <p>
                                                        <strong>{{ __('Price') }} :</strong> {{$order->currency_sign}}{{ (int)$product['item']['price'] * $order->currency_value  }}
                                                </p>
                                               <p>
                                            ...
                                            <td>{{$order->currency_sign}}{{ (int)$product['price'] * $order->currency_value }}</td>
