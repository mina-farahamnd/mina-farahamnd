            ...
            <div class="body-area" id="modalEdit">
              ...
              <form id="geniusformdata" action="{{route('admin-attr-store')}}" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                         <div class="row mb-2 counterrow" v-for="n in counter" :id="'counterrow'+n">
                           ...
                           <div class="col-lg-6">
                           <input :id="'optionfield'+n" type="text" class="input-field" name="options[]" value="" placeholder="{{__('Option label')}}" required>
                           </div>
                           <div class="col-lg-1">
                ...
                <div class="row mb-4 mt-1">
                  <div class="col-lg-12">
                    <div class="custom-control custom-checkbox">
                      <input type="checkbox" id="searchStatus1" name="search_status" class="custom-control-input"  value="1">
                      <label class="custom-control-label" for="searchStatus1">جستجو در صفحه جزئیات</label>
                    </div>
                  </div>
                </div>
