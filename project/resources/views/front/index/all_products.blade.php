...
<style>
   ...
   .product_category{margin-right: 15px;margin-top: 10px;color: #4b4b4b !important;}
   .product_category:hover{color: #4b4b4b !important;}
</style>
<style>
...
<div class="product1 col-sm-12">
    ...
    <div class="col-sm-12">
        ...
        <div class="product2">
            <span class="text-icon-product" style="color: #ED703F;">
         همه محصولات
            </span>
        </div>

        <div class="product2">
            <img class="img-icon-product"  src="{{asset('assets/images/zho/product1.png')}}" >
            <span class="text-icon-product">
            غذا
            </span>
        </div>

        <div class="product2">
            <img class="img-icon-product"  src="{{asset('assets/images/zho/product2.png')}}" >
            <span class="text-icon-product">
           لوازم
           </span>
        </div>
        ...
        <div class="product2">
            <img class="img-icon-product"  src="{{asset('assets/images/zho/product3.png')}}" >
            <span class="text-icon-product">
           اسباب بازی
            </span>
        </div>
        ...
        <div class="product2">
            <img class="img-icon-product"  src="{{asset('assets/images/zho/product4.png')}}" >
            <span class="text-icon-product">
           دارو
           </span>
        </div>
        ...
        <div class="product2">
            <img class="img-icon-product"  src="{{asset('assets/images/zho/product5.png')}}" >
            <span class="text-icon-product">
           پوشاک
            </span>
        </div>
    ...
    <div class=" row" style="width:100%;float:right;margin: 0;padding-top: 20px;">
        ...
        <div class="col-md-3 col-sm-6 content" id="product">
    ...
    <a href="#" id="loadMore" class="show-more">
        نمایش بیشتر
    </a>
    ...
    $(document).ready(function(){
        ...
        $("#loadMore").on("click", function(e){
            ...
            if($(".content:hidden").length == 0) {
              //  $("#loadMore").text("نمایش همه محصولات").addClass("noContent");
