...
<div class="product1 col-sm-12">
    ...
    <div class=" row" style="width:100%;float:right;margin: 0;padding-top: 20px;">
        ...
        @if(!empty($last_products))
            @foreach ( $last_products as $prod)
                <div class="col-md-3 col-sm-6 content3">
    ...
    <div class=" row" style="width:100%;float:right;margin: 0;padding-top:5px;">
        ...
        <a href="#" id="loadMore3" class="show-more">
            نمایش بیشتر
        </a>
...
<script>
    $(document).ready(function(){
        $(".content3").slice(0, 4).show();
        $("#loadMore3").on("click", function(e){
            e.preventDefault();
            $(".content3:hidden").slice(0, 4).slideDown();
            if($(".content3:hidden").length == 0) {
              //  $("#loadMore3").text("نمایش همه محصولات").addClass("noContent");
